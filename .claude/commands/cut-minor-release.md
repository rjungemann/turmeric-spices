---
description: Cut a new minor release of a single spice. Bump build.tur :version, update CHANGELOG, deploy docs, push tag.
argument-hint: <spice-name>
allowed-tools: Bash, Read, Edit, AskUserQuestion
---

# Cut a new minor release of a spice

Run a full minor-version release of one spice in this workspace.
...
Omit empty subsections. Aim for 3-10 bullets total -- consolidate
